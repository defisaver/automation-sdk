...
export namespace Bundles {
  export enum MainnetIds {
    ...
    AAVE_V3_EOA_BOOST_ON_PRICE = 54,
    AAVE_V3_EOA_REPAY_ON_PRICE = 55,
  ...
  export enum OptimismIds {
    ...
    AAVE_V3_EOA_REPAY = 6,
    AAVE_V3_EOA_BOOST = 7,
    AAVE_V3_EOA_BOOST_ON_PRICE = 8,
    AAVE_V3_EOA_REPAY_ON_PRICE = 9,
  ...
  export enum BaseIds {
    ...
    AAVE_V3_EOA_BOOST_ON_PRICE = 25,
    AAVE_V3_EOA_REPAY_ON_PRICE = 26,
  ...
  export enum ArbitrumIds {
    ...
    AAVE_V3_EOA_BOOST_ON_PRICE = 20,
    AAVE_V3_EOA_REPAY_ON_PRICE = 21,
